"""Super mechanical code to naively path from x, y to nx, ny.

Returns the next step based on some greedy heuristics.
"""
...
def can_occupy_safely(x, y, nx, ny, gm):
    """Detect if nx, ny can be 'safely' moved into by x, y."""
